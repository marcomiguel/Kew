...
<?php get_header(); ?>
	...
	<div id="relictos">	
		...
		<section id="titulo">
			...
			<div class="row">
				...
				<div class="twelve columns">
					...
					<h1 class="title-page">Bosques y Tierras de Niños</h1>
		...
		<!--<section id="relictos-mapa" >
			
			<div class="row container-up centered">
		...
		<section id="relictos-mapa"  style="margin-left: 12px;width: 978px;height: 420px;">
					...
					<div id="map-canvas-trees" style="width: 978px;height: 420px;margin-top:40px"></div>
