...
$meta_boxes[] = array(
    ...
    'fields' => array(    
		...
		array(
		 ...
		 array(
            'name' => 'Centro poblado más cercano',
            'id'   => 'cf_localidad',
            'type' => 'text',
...
$meta_boxes[] = array(
    ...
    'fields' => array(    
        ...
        array(
            'name' => 'Superficie de la cobertura vegetal (ha)',
            'id'   => 'cf_superficie_cobertura_vegetal',
            'type' => 'text',
            'desc' => 'Por ejemplo: 99.51',
